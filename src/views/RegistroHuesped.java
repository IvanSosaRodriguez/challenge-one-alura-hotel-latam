...
public class RegistroHuesped extends JFrame {
	...
	RegistrosController controller;
	...
	public RegistroHuesped() {
		...
		lblTitulo.setBounds(585, 55, 245, 42);
		lblTitulo.setForeground(new Color(12, 138, 199));
		lblTitulo.setFont(new Font("Roboto Black", Font.PLAIN, 23));
		contentPane.add(lblTitulo);

		JLabel lblNumeroReserva = new JLabel("SU NÚMERO DE RESERVA ES");
		lblNumeroReserva.setBounds(560, 474, 270, 14);
		lblNumeroReserva.setForeground(SystemColor.textInactiveText);
		lblNumeroReserva.setFont(new Font("Roboto Black", Font.PLAIN, 18));
		contentPane.add(lblNumeroReserva);

		txtNreserva = new JLabel();
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (txtNombre.getText() != null && txtApellido.getText() != null
						&& txtFechaN.getDate() != null && telefono.equals("") == false) {

					if (isNumeric(telefono) == true) {
						controller = new RegistrosController();
						JOptionPane.showMessageDialog(null, "se guargadaron los datos");
						try {
							controller.GuardarHuespedes(guardarDatos(), ReservasView.numeroRegistro);
		...
		txtNreserva.setText(String.valueOf(ReservasView.numeroRegistro));
	}
	...
	private Map<String, String> guardarDatos() {

		Map<String, String> datos = new HashMap<>();

		datos.put("NOMBRE", txtNombre.getText());
		datos.put("APELLIDO", txtApellido.getText());
		datos.put("FECHADENACIMIENTO", String.valueOf(new Date(txtFechaN.getDate().getTime())));
		datos.put("NACIONALIDAD", txtNacionalidad.getSelectedItem().toString());
